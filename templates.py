...
def set_template(args):
    if args.template is None:
        ...
        #     print("Setting template for BERT training...")
        #     args.dataset_code = (
        #         "ml-" + input("Input 1 for ml-1m, 20 for ml-20m: ") + "m"
        #     )
        ...
        # if DDP is used, num_gpu and device_idx will not be used
        # args.num_gpu = 1
        # args.device_idx = '0'
        ...
        if torch.cuda.is_available():
            ...
            args.device = "musa"
        # args.num_gpu = 1     # if DDP is used, num_gpu and device_idx will not be used
        # args.device_idx = '0'
        args.optimizer = "Adam"
        args.lr = 1e-3
